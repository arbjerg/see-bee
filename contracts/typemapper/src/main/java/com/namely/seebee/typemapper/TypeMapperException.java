...
public class TypeMapperException extends RuntimeException {
    static final long serialVersionUID = -239746074765476L;
    /**
     ...
     */
    public TypeMapperException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *
     */
    protected TypeMapperException(String message, Throwable cause,
